namespace ArcCore.Utility
{
    ...
    public class StringParser
    {
        ...
        {
            static string GetMessage(int ch, StringParser p, string message)
            {
                string m = message + "\n";
            ...
            private protected BadParseException(int character, StringParser parser, string message)
        ...
        {
            internal UnexpectedEOSException(int character, StringParser parser, string message)
                : base(character, parser, message) {}
        }
        [Serializable]
        public sealed class UnexpectedCharException : BadParseException
        {
            internal UnexpectedCharException(int character, StringParser parser, string message)
                : base(character, parser, message) { }
        }
        [Serializable]
        public sealed class BadLiteralException : BadParseException
        {
            internal BadLiteralException(int character, StringParser parser, string message)
                : base(character, parser, message) { }
        }
        #endregion
