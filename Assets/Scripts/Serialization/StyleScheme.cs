...
namespace ArcCore.Serialization
{
    public class StyleScheme : ICloneable, IEquatable<StyleScheme>
    {
        ...
        {
            int hashCode = -477182784;
            hashCode = hashCode * -1521134295 + trackColor.GetHashCode();
            hashCode = hashCode * -1521134295 + particleColor.GetHashCode();
            hashCode = hashCode * -1521134295 + tapColor.GetHashCode();
            hashCode = hashCode * -1521134295 + holdColor.GetHashCode();
            hashCode = hashCode * -1521134295 + arctapColor.GetHashCode();
            return hashCode;
        }
